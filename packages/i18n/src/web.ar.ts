...
export const webAr: WebMessages = {
  web: {
    ...
    assistant: {
      ...
      talk: 'اضغط لتتحدّث',
      listening: 'يستمع…',
      voiceHint: 'تحدّث بشكل طبيعي — المساعد يستمع.',
      emptyTranscript: 'قل مرحبًا أو اكتب رسالة للبدء.',
      you: 'أنت',
      cookAsk: 'اسأل المساعد',
      cookAskHint: 'مساعدة بدون يدين أثناء الطبخ — فقط تحدّث.',
      cookClose: 'إغلاق المساعد',
      micNeededTitle: 'الميكروفون محظور',
      micNeededBody: 'اسمح بالميكروفون للتحدث مع المساعد، أو انتقل إلى النص.',
      voiceConsentTitle: 'تحدّث مع المساعد',
      voiceConsentBody: 'اسمح بالميكروفون وابدأ الحديث — مثل مكالمة هاتفية.',
      voiceConsentStart: 'ابدأ الحديث',
      switchToText: 'اكتب بدلًا من ذلك',
      close: 'إغلاق',
    },
    deleteAccount: {
      link: 'حذف الحساب',
