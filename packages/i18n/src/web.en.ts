...
export const webEn = {
  web: {
    ...
    assistant: {
      ...
      talk: 'Hold to talk',
      listening: 'Listening…',
      voiceHint: 'Speak naturally — the assistant is listening.',
      emptyTranscript: 'Say hello or type a message to start.',
      you: 'You',
      cookAsk: 'Ask the assistant',
      cookAskHint: 'Hands-free help while you cook — just talk.',
      cookClose: 'Close assistant',
      micNeededTitle: 'Microphone is blocked',
      micNeededBody: 'Allow the microphone to talk to the assistant, or switch to text.',
      voiceConsentTitle: 'Talk with the assistant',
      voiceConsentBody: 'Allow the microphone and just start talking — like a phone call.',
      voiceConsentStart: 'Start talking',
    ...
    admin: {
      ...
      credits: {
        ...
        intro:
          'What each action is priced at against what the vendor actually charged us for it, measured from the credit and usage ledgers. Underpriced actions lose money on every use.',
        window: 'Window',
        windowDays: 'Last {days} days',
        since: 'Measured since {date}',
        costBasis: 'Cost basis',
        creditValue: 'Sale value',
        perCredit: '{usd} / credit',
        colAction: 'Action',
        colListed: 'Listed',
        colMeasured: 'Measured',
        colCharges: 'Charges',
        colCalls: 'Vendor calls',
        colStatus: 'Status',
        credits: plural('count', { one: '{count} credit', other: '{count} credits' }),
        notMeasured: 'Not measured',
        unmeasurableNote: 'Billed by the provider — cannot be read from our ledger.',
        chargedNote: '{measured} of {charged} charges measured',
        empty: 'No credit actions to show.',
        ...
        action: {
          ...
          planRegenerate: 'Regenerate meal',
