...
export const mobileEn = {
  mobile: {
    ...
    assistant: {
      ...
      entryHint: 'Chat, talk, or point the camera — demo mode.',
      ...
      voiceTitle: 'Talk with the assistant',
      voiceHint: 'Just start talking — like a phone call. Demo mode.',
      cameraTitle: 'Cook with a live assistant',
      cameraHint: 'Point the camera at your food and talk while it looks. Demo mode.',
