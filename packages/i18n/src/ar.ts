...
export const ar: Messages = {
  ...
  errors: {
    ...
    timedOut:
      'استغرق ذلك وقتًا أطول من المتوقع. قد يكون قد اكتمل بالفعل — تحقّق قبل إعادة المحاولة.',
    emptyPantry:
  ...
  personaDescription: {
    layla: 'دافئة وعلى مهلها، تشرح لكِ الوصفة كما تشرحها صديقة.',
    noor: 'هادئة ومتزنة، تدخل في صلب الموضوع.',
    salma: 'حيوية وسريعة، رفيقة جيدة في مطبخ مزدحم.',
    omar: 'متأنٍّ وواضح، يتحدث بالعربية الفصحى.',
  },
  dialect: {
