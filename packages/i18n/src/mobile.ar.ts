  ...
  mobile: {
    ...
    recipe: {
      ...
      startStepTimer: plural('minutes', {
        one: 'ابدأ مؤقتًا دقيقة واحدة',
        two: 'ابدأ مؤقتًا دقيقتين',
        few: 'ابدأ مؤقتًا {minutes} دقائق',
        many: 'ابدأ مؤقتًا {minutes} دقيقةً',
        other: 'ابدأ مؤقتًا {minutes} دقيقة',
      }),
    ...
    screen: {
      title: 'شاشة المطبخ',
      entry: 'شاشة المطبخ',
      entryHint: 'أسند الهاتف على الطاولة: الساعة والتنبيهات والمؤقت في لمحة.',
      exit: 'خروج',
      planLabel: 'خطة العافية اليوم',
      planIdleLabel: 'تذكيرات العافية مغلقة',
      planIdle: 'شغّل التنبيهات اللطيفة وستظهر خطتك هنا.',
      planIdleCta: 'إعدادات التذكير',
      timerLabel: 'مؤقت الطهي',
      timerEmpty: 'لا مؤقت يعمل',
      timersCta: 'المؤقتات',
      ...
      nudgeAcknowledge: 'تم',
      rotateHint: 'أدر الهاتف أفقيًا لعرض أوسع.',
    },
    wellness: {
    ...
    assistant: {
      ...
      entryHint: 'دردش أو تحدّث أو وجّه الكاميرا — وضع تجريبي.',
      ...
      modeVoice: 'صوت',
      modeLive: 'مباشر',
      composerPlaceholder: 'راسل المساعد…',
      send: 'إرسال',
      emptyTranscript: 'ابدأ بإلقاء التحية أو كتابة رسالة.',
      voiceTitle: 'تحدّث مع المساعد',
      voiceHint: 'ابدأ الحديث فقط — مثل مكالمة هاتفية. وضع تجريبي.',
      cameraTitle: 'اطبخ مع مساعد مباشر',
      cameraHint: 'وجّه الكاميرا إلى طعامك وتحدّث بينما ينظر. وضع تجريبي.',
      cookAsk: 'اسأل المساعد',
      cookClose: 'إغلاق المساعد',
      confirmTitle: 'إضافة العناصر المرصودة',
      confirmBody: 'هذه عناصر عيّنة تم رصدها. راجعها وأضِف ما لديك فعلاً.',
      confirmEmpty: 'لم يُرصد شيء بعد — أبقِ الكاميرا على طعامك للحظة.',
    },
    offlineBanner: 'غير متصل — تُحفظ التغييرات وستتم مزامنتها تلقائياً.',
  },
};
